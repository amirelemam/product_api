...
export class CreateProductMigration1725904347470 implements MigrationInterface {
    name = 'CreateProductMigration1725904347470'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."product_currency_enum" AS ENUM('USD')`);
